...
export default function PropertyList() {
  ...
  const [filters, setFilters] = useState({ property_type: '', unit_type: '', project_name: '', listing_type: '', availability: '', status: '', city: '', society_name: '', tower: '', created_by_employee: '', date_from: '', date_to: '' });
